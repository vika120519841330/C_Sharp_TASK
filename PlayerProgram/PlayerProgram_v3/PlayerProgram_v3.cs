...
namespace Player
{
    ...
    public class Player : IPlayable, IRecordable
    {
        ...
        public int Status
        {
            ...
            set
            {
                ...
                {
                    Console.WriteLine("Плеер может находится в одном из четырех состояний:" +
                        "0 - STOP, 1 - PLAY, 2 - PAUSE, 3 - RECORD");
                    return;
                }
            }
        }
        public void Play()
        {
            ...
            {
                Console.WriteLine($"{this.GetType().Name} is <<PLAY>>.");
                this.Status = 1;
            }
            else
            {
                Console.WriteLine($"{this.GetType().Name} уже находится в состоянии <<PLAY>>!!");
            }
        }
        ...
        void IPlayable.Pause()
        {
            if (this.Status == 1)
            {
                Console.WriteLine($"{this.GetType().Name} is <<PAUSE>>.");
                this.Status = 2;
            }
            else
            {
                Console.WriteLine($"Чтобы поставить {this.GetType().Name} на паузу он должен находится в состоянии <<PLAY>>!!");
            }
        }
        void IRecordable.Pause()
        {
            ...
            {
                Console.WriteLine($"Чтобы поставить {this.GetType().Name} на паузу он должен находится в состоянии <<RECORD>>!!");
            }
        }
        void IPlayable.Stop()
        {
            ...
            {
                Console.WriteLine($"{this.GetType().Name} is <<STOP>>.");
                this.Status = 0;
            }
            else
            {
                Console.WriteLine($"{this.GetType().Name} уже находится в состоянии <<STOP>>!!");
            }
        }
        ...
        public void Record()
        {
            if ((this.Status == 0) || (this.Status == 2))
            {
                Console.WriteLine($"{this.GetType().Name} is <<RECORD>>.");
                this.Status = 3;
            }
            else
            {
                Console.WriteLine($"{this.GetType().Name} уже находится в состоянии <<RECORD>>!!");
            }
        }
    }
    ...
    public class Album
    {
        ...
        public Song this[int ind]
        {
            ...
            {
                int temp = ind + 1;
                if (temp > 0 && ind <= SongList.Count)
                    return SongList[ind];
                else
                {
                    Console.WriteLine($"Номер трека должен находится в пределах от 1 до {SongList.Count}");
                    return null;
                }
            }
            set
